...
const char *gengetopt_args_info_usage = "Usage: Ficha 4 PA [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -t, --threads=INT    nr of threads to use",
  "  -f, --file=dirname   file",
  "  -b, --blocksize=INT  block size in for each thread",
    0
};
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->blocksize_given)
    {
      fprintf (stderr, "%s: '--blocksize' ('-b') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:f:b:", long_options, &option_index);
