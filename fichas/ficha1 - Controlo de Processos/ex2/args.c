...
const char *gengetopt_args_info_purpose = "Create n processes";

const char *gengetopt_args_info_usage = "Usage: Ficha 1 - PA [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -n, --num_procs=INT  Number of processes to list",
    0
};
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'n':	/* Number of processes to list.  */
